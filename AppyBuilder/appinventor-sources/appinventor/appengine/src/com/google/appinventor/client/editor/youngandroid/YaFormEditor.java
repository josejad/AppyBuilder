...
public final class YaFormEditor extends SimpleEditor implements FormChangeListener, ComponentDatabaseChangeListener {
  ...
  private MockComponent createMockComponent(JSONObject propertiesObject, MockContainer parent) {
    ...
    //todo: will happen when going from silver to gold, because silver doesn't have AppName
...
//        String projectName = fileId.split("/")[3];  //hossein: packageName. for appinventor.ai_kkashi01.PACKAGE.APP, get the 3rd element
//        String projectName = fileId.split("/")[4];  //hossein: packageName. for com.appybuilder.kkashi01.PACKAGE.APP, get the 4th element
