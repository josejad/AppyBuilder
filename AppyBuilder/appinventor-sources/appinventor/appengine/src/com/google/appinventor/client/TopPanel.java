  ...
  public TopPanel() {
    ...
    donateLink.addClickHandler(new ClickHandler() {
      ...
      public void onClick(ClickEvent clickEvent) {
        Window.open("https://www.paypal.me/appybuilder", "donate", "menubar=yes,location=yes,resizable=yes,scrollbars=yes,status=yes");
      }
    });
...
*/
  ...
  private void addDonateButton(HorizontalPanel panel) {
    Image image = new Image(DONATE_IMAGE_URL + "?t=" + System.currentTimeMillis());
    image.setSize("191px", "40px");
    image.setStyleName("ode-Logo");
    image.addClickHandler(new ClickHandler() {
      @Override
      public void onClick(ClickEvent clickEvent) {
    ...
    panel.add(image);
    panel.setCellWidth(image, "50px");
    panel.setCellHorizontalAlignment(image, HorizontalPanel.ALIGN_LEFT);
    panel.setCellVerticalAlignment(image, HorizontalPanel.ALIGN_MIDDLE);
    panel.setCellWidth(image, "228px");
  }
