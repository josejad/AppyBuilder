 ...
 *
 */
public final class MockRadioButton2 extends MockVisibleComponent {

  /**
   * Component type name.
   */
  public static final String TYPE = "RadioButton2";
   ...
   */
  public MockRadioButton2(SimpleEditor editor) {
