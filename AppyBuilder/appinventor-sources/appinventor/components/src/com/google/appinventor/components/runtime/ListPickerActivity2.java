...
// */
//public class ListPickerActivity2 extends Activity implements AdapterView.OnItemClickListener, OnDismissCallback {
//    private String TAG = "ListPickerActivity";
//
...
//        }
//
//        isRepl = Boolean.valueOf(myIntent.getStringExtra(ListPicker.LIST_ACTIVITY_IS_REPL));
//
...
//                setupStyle(adapter);
//            } else {
//                Log.d(TAG, "listview has no images");
//
//                // User didn't pass any images
//                itemsArrayList = itemsToArrayList();
//                simpleAdapter = new AdapterNoImages(this, itemsArrayList);
//                listView.setAdapter(simpleAdapter);
//                setupStyle(simpleAdapter);
//
//            }
//
...
//                    ListPickerActivity2.this.adapter.getFilter().filter(cs);
//                }
//
//                @Override
...
//        } else {
//            adapterNoImageClicked(parent, view, position, id);
//        }
//    }
//
...
//        resultIntent.putExtra(ListPicker.LIST_ACTIVITY_ITEMS, itemsToArrayList()); //add this in case user has removed items
//        closeAnim = selected;
...
//    }
//
//    private void adapterNoImageClicked(AdapterView<?> parent, View view, int position, long id) {
...
//            if (this.adapter != null) adapter.remove(position);
//            else if (this.simpleAdapter != null) simpleAdapter.remove(position);
//        }
...
//
//    //======================== SimpleAdapter
//    private static class AdapterNoImages extends ArrayAdapter<String> {
//
//        private final Context mContext;
//
//        public AdapterNoImages(final Context context, final ArrayList<String> items) {
//            super(items);
//            mContext = context;
//        }
//
