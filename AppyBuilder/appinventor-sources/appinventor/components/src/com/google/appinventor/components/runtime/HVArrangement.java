...
//        getView().setBackgroundColor(argb);
  ...
  //https://stackoverflow.com/questions/17903105/android-how-to-add-swipe-gesture-on-linearlayout-without-ondown-true
  // made below to generate compile error so that I know here I left
...
////    return false;
//
////    implement: https://stackoverflow.com/questions/17903105/android-how-to-add-swipe-gesture-on-linearlayout-without-ondown-true
...
//          }
//        } else {
//          Log.d(LOG_TAG, "Swipe was only " + Math.abs(deltaX) + " long horizontally, need at least " + MIN_DISTANCE);
...
//
//  /**
//   * Indicates a swipe was down .
//   */
//  @SimpleEvent(description = "Fling")
//  public boolean Fling(String direction) {
//    return EventDispatcher.dispatchEvent(this, "Fling");
//  }
