...
public final class Compiler {
  ...
  //todo: hossein. DON NOT hard code this. this should come in from project fileimporter. Maybe through annotation??
...
//     System.out.println("Component activities needed, n = " + n);
  ...
  private boolean writeAndroidManifest(File manifestFile) {
    ...
    LOG.log(Level.INFO, "=====>userApplicationPackage: " + userApplicationPackage);
    ...
    try {
      ...
      String targetSdkVersion = " android:targetSdkVersion=\"22\" ";
...
//      out.write("  <application android:theme=\"@android:style/Theme.Holo\" ");
//      out.write("  <application android:theme=\"@android:style/Theme.AppCompat\" ");
...
//      out.write(" android:theme=\"@android:style/Theme.Material.Light\" ");
      ...
      for (Project.SourceDescriptor source : project.getSources()) {
        ...
        // commenting out below, so that we write the full qualified (see above) class name
        /*if (isMain) {
...
/*        if (isMain) {
      ...
      if (simpleCompTypesString.contains("OneSignalPush") || simpleCompTypesString.contains("GoogleMap") || simpleCompTypesString.contains("AdMob") || simpleCompTypesString.contains("RewardedVideo")
              ||simpleCompTypesString.contains("MMedia") || isForCompanion) {
        System.out.println("Android Manifest: including AdMob or GoogleMap tag");
        //todo: use below for legacy admob
//        out.write("<activity android:name=\"com.google.ads.AdActivity\" android:configChanges=\"keyboard|keyboardHidden|orientation|screenLayout|uiMode|screenSize|smallestScreenSize\"/>");
        //todo: use NEXT 2 below for new admob (i.e. after aug 1st)
...
//        out.write("<meta-data android:name=\"com.google.android.gms.version\" android:value=\"5077000\"/>");
//        out.write("<meta-data android:name=\"com.google.android.gms.version\" android:value=\"8487000\"/>");
      ...
      if (simpleCompTypesString.contains("AdAmazon") || simpleCompTypesString.contains("AdAmazonInterstitial" ) || isForCompanion) {
        System.out.println("Android Manifest: including <AdAmazon> tag");
      ...
      if (simpleCompTypesString.contains("MobFoxInterstitial") ) {
        System.out.println("Android Manifest: including <MobFoxInterstitial> tag");
      ...
      if (simpleCompTypesString.contains("MMediaInterstitial") || simpleCompTypesString.contains("MMedia") ) {
        // special handling required in 2 places. Search for mmedia in this file
        System.out.println("Android Manifest: including <MMediaInterstitial> tag");
//        out.write("<activity android:name=\"com.millennialmedia.android.MMActivity\" android:theme=\"@android:style/Theme.Translucent.NoTitleBar\" android:configChanges=\"keyboardHidden|orientation|keyboard\" ></activity>");
      ...
      if (simpleCompTypesString.contains("FacebookInterstitial") ) {
        System.out.println("Android Manifest: including <FacebookInterstitial> tag");
//        out.write("<activity android:name=\"com.facebook.ads.InterstitialAdActivity\" android:configChanges=\"keyboardHidden|orientation|screenSize\" />");
...
//      }
  ...
  public static boolean compile(Project project, Set<String> compTypes,
    ...
    System.out.println("________Preparing application icon in: " + drawableDir.getAbsolutePath());
    ...
    //============ start: styles
/*    File valuesDir = createDir(resDir, "values");
    System.out.println("________Creating values xml:" + valuesDir.getAbsolutePath());
    if (!compiler.createValuesXml(valuesDir)) {
      return false;
    }
    */
    //============ end: styles
...
//    Map<String, String> files = new HashMap<String, String>();
//
////    files.put("styles.xml", AnimationXmlConstants.APP_COMPAT_STYLES);
//    files.put("styles.xml", getAppCompatValues());
//
//    for (String filename : files.keySet()) {
//      File file = new File(valuesDir, filename);
//      if (!writeXmlFile(file, files.get(filename))) {
//        System.out.println("____ Unable to create dir: " +file.getAbsolutePath());
//        return false;
//      } else {
//        System.out.println("____ Created values dir:" + file.getAbsolutePath());
//      }
//    }
//
//    return true;
//  }
  ...
  private boolean createOkayGoogle(File aDir, String appName) {
    Map<String, String> files = new HashMap<String, String>();
    String searchable = AnimationXmlConstants.OKAY_GOOGLE_SEARCHABLE;
    searchable = searchable.replace("$[REPLACE_WITH_APP_NAME]", appName);
    files.put("searchable.xml", searchable);
...
//        class2List.add(new File(lib));
    ...
    synchronized (SYNC_KAWA_OR_DX) {
      ...
      if (dxSuccess && class2List.size() > 0 ) {
        System.out.println("***** has class2List");
        setProgress(60);
